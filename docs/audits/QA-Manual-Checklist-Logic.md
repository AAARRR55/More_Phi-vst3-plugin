...
|---|------|-----------|--------|-------|
| 8.1.1 | Plugin scan | Open Audio Units Manager, scan for plugins | ☐ PASS ☐ FAIL | More-Phi AU appears with correct name and version |
| 8.1.2 | Instantiation | Insert More-Phi on audio instrument track | ☐ PASS ☐ FAIL | Must load without crash; UI renders correctly |
...
| 8.4.2 | Smart Controls | Open Smart Controls for More-Phi | ☐ PASS ☐ FAIL | Parameters must be mappable to Smart Controls |
| 8.4.3 | Track stack | Use More-Phi inside a track stack | ☐ PASS ☐ FAIL | Full functionality — no crash or routing issues |
| 8.4.4 | AU MIDI effects | Insert More-Phi as MIDI FX on instrument track | ☐ PASS ☐ FAIL | MIDI notes must trigger snapshot recalls |
| 8.4.5 | Bounce/render | Bounce track with More-Phi offline, compare with real-time render | ☐ PASS ☐ FAIL | Offline render must match real-time audio (no artifacts) |
